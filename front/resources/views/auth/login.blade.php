                    ...
                    <div class="login-form">
                        ...
                        <form method="POST" action="{{ Route('login.submit') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control pl-3" name="email" placeholder="Email" required autofocus>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="text-center">
                            <a class="text-primary" href="{{ Route("register") }}">Belum mempunyai akun ?</a>
                        </div>
                    </div>
                </div>
            </div>
